"""
This file controls the project by pulling all of the leavers and ringing all of the bells!
"""
import sys
...
# **********initialises login page page **************
@app.route('/login/', methods=['GET', 'POST'])
def sign_in():
    # ********* this conditional statement deals with a weird situation. Imagine you have a user that is loggedin, and the user navigates to the /login url of your application. Clearly that is a mistake, so we want to prevent that from happeing. We use a redirect to any other route function of our choice....
...
def logout():
    logout_user()
    return redirect(url_for('home'))
# **********initialises home redirect page **************
@app.route('/home/')
def home_redirect():
    return render_template('home.html')
# **********initialises registration page and its forms**************
